...
<p align="center">
  <img src=/assets/images/blogs/party_pic.png height=500 width=700
</p>  
...
[PageRank](http://en.wikipedia.org/wiki/PageRank), which is used for web ranking. The most tightly coupled pairs (best friends) that tend to coappear with each other are graph edges with highest weight. The 

can be found by cointing the number of connection 

The PageRank algorithm outputs a probability distribution used to represent the likelihood that a person randomly clicking on links will arrive at any particular page

identify most popular (influnetioanl) people, their best friends
 Using this graph, we can make guesses at the most popular socialites, the most influential people, and the most tightly coupled pairs.
most influential people, and the most tightly coupled pairs![image](https://user-images.githubusercontent.com/34116430/142748957-b0cad2e2-f00c-4969-baf4-596b388d8e45.png)



<p align="center">
  <img src=/assets/images/blogs/social_graph.png height=500 width=500>
</p>
